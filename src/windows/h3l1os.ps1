...
#   - API endpoints on Cloudflare Worker at api.heliosprima.com/v1/*
#
...
$script:LicenseUrl    = 'https://api.heliosprima.com/v1/license/check'
$script:VersionUrl    = 'https://api.heliosprima.com/v1/version'
$script:TelemetryUrl  = 'https://api.heliosprima.com/v1/telemetry/event'
