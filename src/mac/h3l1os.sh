...
__h3l1os_main() {
    ...
    #   - API endpoints on Cloudflare Worker at api.heliosprima.com
    ...
    readonly H3L1OS_LICENSE_URL="https://api.heliosprima.com/v1/license/check"
    readonly H3L1OS_VERSION_URL="https://api.heliosprima.com/v1/version"
    readonly H3L1OS_TELEMETRY_URL="https://api.heliosprima.com/v1/telemetry/event"
